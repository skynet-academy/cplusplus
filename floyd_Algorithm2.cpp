...
#include <limits.h>
#include <cstddef>
void printGraph(std::vector<std::vector<double>> dist, std::vector<std::vector<int>> next) {
...
void solveGraph(std::vector<std::vector<int>> w_s, const int num_vertices){
